...
A collection of skills for [Claude Code](https://claude.com/claude-code) and other AI agents.
...
| [ofac-screen](https://github.com/HartreeWorks/skill--ofac-screen) | Screen payees against OFAC sanctions lists and save matching evidence for review. |
...
| [gdoc-to-substack](https://github.com/HartreeWorks/skill--gdoc-to-substack) | Convert a Google Doc into a Substack draft post: native footnotes, uploaded images, and tables rendered as images. |
...
| [find-hotel](https://github.com/HartreeWorks/skill--find-hotel) | Search hotels, cross-check Booking.com against the property's direct site, and drive a reservation up to the payment step. |
